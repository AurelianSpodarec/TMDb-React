...
function Header() {
    return (
        <header className="text-gray-100 bg-[#0c0e11]">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            <a href="javascript:void(0)" className="flex title-font font-medium items-center text-rose-500 mb-4 md:mb-0">
                ...
                <span className="ml-3 text-xl">DateMovie</span>
            </a>
